...
public class SmallBasicLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "COMENTARIO", "ESP", "PR", "RELOP", "OPSUM", "OPMUL", "TKN_FOR", 
			"TKN_TO", "TKN_STEP", "TKN_ENDFOR", "TKN_WHILE", "TKN_ENDWHILE", "TKN_IF", 
			"TKN_THEN", "TKN_ELSE", "TKN_ELSEIF", "TKN_ENDIF", "TKN_SUB", "TKN_ENDSUB", 
			"TKN_GOTO", "TKN_ARRAY", "TKN_TEXTWINDOW", "TKN_PROGRAM", "TKN_STACK", 
			"TKN_MINUS", "ID", "VERDADERO", "FALSO", "NUM", "TEXT"
		};
	}
	...
	public SmallBasicLexer(CharStream input) {
		super(input);
